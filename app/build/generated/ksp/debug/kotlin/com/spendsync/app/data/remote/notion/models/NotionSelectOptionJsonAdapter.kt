...
public class NotionSelectOptionJsonAdapter(
  moshi: Moshi,
) : JsonAdapter<NotionSelectOption>() {
  ...
  override fun toString(): String = buildString(40) {
      append("GeneratedJsonAdapter(").append("NotionSelectOption").append(')') }

  override fun fromJson(reader: JsonReader): NotionSelectOption {
    ...
    reader.endObject()
    return NotionSelectOption(
        name = name ?: throw Util.missingProperty("name", "name", reader)
    )
  }

  override fun toJson(writer: JsonWriter, value_: NotionSelectOption?) {
    if (value_ == null) {
