...
public final class SettingsDataStore_Factory implements Factory<SettingsDataStore> {
  ...
  public static SettingsDataStore_Factory create(javax.inject.Provider<Context> contextProvider) {
    return new SettingsDataStore_Factory(Providers.asDaggerProvider(contextProvider));
  }
