    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          ...
          return (T) new HomeViewModel(viewModelCImpl.getExpensesUseCase(), viewModelCImpl.getSpendingSummaryUseCase(), viewModelCImpl.deleteExpenseUseCase(), singletonCImpl.authDataStoreProvider.get());
